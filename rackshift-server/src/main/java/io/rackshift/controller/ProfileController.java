...
public class ProfileController {
    ...
    public ResultHolder getAllProfiles() {
        return ResultHolder.success(profileService.getAllProfiles());
    }

    @RequiresRoles(AuthorizationConstants.ROLE_ADMIN)
    @PostMapping("add")
    public ResultHolder add(@RequestBody ProfileDTO queryVO) throws Exception {
